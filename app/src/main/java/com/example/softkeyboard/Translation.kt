...
class Translation(val context: Context) : AsyncTask<String, String, String>() {
...
//        val outputString: String = parseResult(response.toString(), context!!, false)
    ...
    override fun doInBackground(vararg strings: String): String? {
        return if (strings[0] == "auto") callUrlAndParseResult(
                strings[1],
                strings[2]
        ) else callUrlAndParseResult(strings[1], strings[2], strings[3])
    }
